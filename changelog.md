...
- Bumped `htmlcut-core` from `v6.0.0` to `v7.0.0`, refreshed the maintained lockfiles, and re-verified that FFHN's frozen `htmlcut-v1` adapter and single-selected-match persistence contract still hold against the new HTMLCut release line.
