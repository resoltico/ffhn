...
- [file-target-with-notifications/README.md](file-target-with-notifications/README.md): materializes a valid file-backed `ffhn.target`, runs it against included sample HTML, and demonstrates notification-route behavior on both POSIX shells and PowerShell without requiring a live website
