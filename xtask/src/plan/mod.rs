...
pub(crate) use paths::{
    ...
    fuzz_manifest_path, normalize_path, release_binary_path, semver_baseline_path,
...
pub(crate) use paths::{
    ...
    coverage_target_root_for_tests, release_binary_path_for_tests, semver_scratch_dir_for_tests,
    sibling_artifact_dir_for_tests, with_cargo_artifact_root_overrides,
};
#[cfg(test)]
