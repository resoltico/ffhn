...
pub(crate) fn persist_state_only(
    ...
    #[rustfmt::skip]
    let state = build_state_update(prior_state, run_outcome, failure_cause, run_started_at)?;
...
fn build_state_update(
    ...
    build_state_without_snapshot_changes(prior_state, outcome, cause, started_at)
}
